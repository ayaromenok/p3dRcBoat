...
module engine2212_basket_inch5_assembly(px=0,py=0,pz=0, rx=0,ry=0,rz=0, isAdhesion=false){
    ...
    rotate([rx,ry,rz]){
        rotate([0,-90,0]){
            ...
            engine2212_mount(0,0,-30, 0,0,135);
        }
    }//transform
}//module                
...
module engine2212_mount(px=0,py=0,pz=0, rx=0,ry=0,rz=0){
    translate([(px), (py), pz])
    rotate([rx,ry,rz]){
        ...
        difference(){
            union(){
                yMinkCubeCyl(30,14,80,3, 43,43,12, 0,90,45);
                yMinkCubeCyl(30,30,5,4, 70.5,70.5,12, 0,90,45);
                yTube(25,24,30, 0,0,12);
            }//union
            yCube(20,8,115, 36,36,12, 0,90,45);
            yCube(70,8,100,  43,43,0, 0,0,45);
